    ...
    <DayPicker
      ...
      classNames={{
        ...
        nav_button: cn(
          ...
          "size-7 bg-transparent p-0 border-slate-700 text-white hover:bg-slate-700 hover:text-white opacity-80 hover:opacity-100"
        ),
        ...
        day_outside:
          "day-outside text-slate-500 aria-selected:text-slate-400",
